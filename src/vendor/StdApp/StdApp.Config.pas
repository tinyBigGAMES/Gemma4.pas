...
destructor TMyrConfig.Destroy();
begin
  Clear();
  inherited;
end;

procedure TMyrConfig.Clear();
begin
...
function TMyrConfig.GetLastError(): string;
begin
  Result := FLastError;
end;

function TMyrConfig.NavigateToTable(const AKeyPath: string;
  const ACreateMissing: Boolean; out ATable: TToml;
  out AFinalKey: string): Boolean;
var
...
function TMyrConfig.GetValueAtPath(const AKeyPath: string;
  out AValue: TTomlValue): Boolean;
var
  LTable:    TToml;
  LFinalKey: string;
...
function TMyrConfig.LoadFromFile(const AFilename: string): Boolean;
begin
  Result := False;
  Clear();
...
function TMyrConfig.LoadFromString(const ASource: string): Boolean;
begin
  Result := False;
  Clear();
...
function TMyrConfig.EscapeString(const AValue: string): string;
begin
  Result := AValue;
...
procedure TMyrConfig.SerializeValue(const AValue: TTomlValue;
  const ABuilder: TStringBuilder);
var
  LArray: TTomlArray;
  LI:     Integer;
...
procedure TMyrConfig.SerializeToml(const AToml: TToml;
  const ABuilder: TStringBuilder; const AIndent: Integer;
  const ATablePath: string);
var
  LKeys:     TArray<string>;
...
function TMyrConfig.SaveToFile(const AFilename: string): Boolean;
var
...
function TMyrConfig.HasKey(const AKeyPath: string): Boolean;
var
  LValue: TTomlValue;
begin
...
function TMyrConfig.GetString(const AKeyPath: string;
  const ADefault: string): string;
var
  LValue: TTomlValue;
begin
...
procedure TMyrConfig.SetString(const AKeyPath: string;
  const AValue: string);
var
  LTable:    TToml;
  LFinalKey: string;
...
function TMyrConfig.GetInteger(const AKeyPath: string;
...
procedure TMyrConfig.SetInteger(const AKeyPath: string;
  const AValue: Int64);
var
  LTable:    TToml;
  LFinalKey: string;
...
function TMyrConfig.GetFloat(const AKeyPath: string;
...
procedure TMyrConfig.SetFloat(const AKeyPath: string;
  const AValue: Double);
var
  LTable:    TToml;
  LFinalKey: string;
...
function TMyrConfig.GetBoolean(const AKeyPath: string;
...
procedure TMyrConfig.SetBoolean(const AKeyPath: string;
...
function TMyrConfig.GetDateTime(const AKeyPath: string;
...
procedure TMyrConfig.SetDateTime(const AKeyPath: string;
...
function TMyrConfig.GetStringArray(const AKeyPath: string): TArray<string>;
var
  LValue: TTomlValue;
  LArray: TTomlArray;
  LI:     Integer;
...
procedure TMyrConfig.SetStringArray(const AKeyPath: string;
  const AValues: TArray<string>);
var
  LTable:    TToml;
  LFinalKey: string;
...
function TMyrConfig.GetIntegerArray(const AKeyPath: string): TArray<Int64>;
var
  LValue: TTomlValue;
  LArray: TTomlArray;
  LI:     Integer;
...
procedure TMyrConfig.SetIntegerArray(const AKeyPath: string;
  const AValues: TArray<Int64>);
var
  LTable:    TToml;
  LFinalKey: string;
...
function TMyrConfig.GetFloatArray(const AKeyPath: string): TArray<Double>;
var
  LValue: TTomlValue;
  LArray: TTomlArray;
  LI:     Integer;
...
procedure TMyrConfig.SetFloatArray(const AKeyPath: string;
  const AValues: TArray<Double>);
var
  LTable:    TToml;
  LFinalKey: string;
...
function TMyrConfig.GetTableCount(const AKeyPath: string): Integer;
var
  LValue: TTomlValue;
begin
  Result := 0;
...
function TMyrConfig.GetTableString(const AKeyPath: string;
  const AIndex: Integer; const AField: string;
  const ADefault: string): string;
var
  LValue:      TTomlValue;
...
function TMyrConfig.GetTableInteger(const AKeyPath: string;
  const AIndex: Integer; const AField: string;
  const ADefault: Int64): Int64;
var
  LValue:      TTomlValue;
...
function TMyrConfig.GetTableFloat(const AKeyPath: string;
  const AIndex: Integer; const AField: string;
  const ADefault: Double): Double;
var
  LValue:      TTomlValue;
...
function TMyrConfig.GetTableBoolean(const AKeyPath: string;
  const AIndex: Integer; const AField: string;
  const ADefault: Boolean): Boolean;
var
  LValue:      TTomlValue;
...
function TMyrConfig.AddTableEntry(const AKeyPath: string): Integer;
var
  LTable:    TToml;
  LFinalKey: string;
  LArray:    TTomlArray;
...
procedure TMyrConfig.SetTableString(const AKeyPath: string;
...
procedure TMyrConfig.SetTableInteger(const AKeyPath: string;
...
procedure TMyrConfig.SetTableFloat(const AKeyPath: string;
...
procedure TMyrConfig.SetTableBoolean(const AKeyPath: string;
...
function TMyrConfig.GetTableStringArray(const AKeyPath: string;
  const AIndex: Integer; const AField: string): TArray<string>;
var
  LValue:      TTomlValue;
  LArray:      TTomlArray;
...
procedure TMyrConfig.SetTableStringArray(const AKeyPath: string;
  const AIndex: Integer; const AField: string;
  const AValues: TArray<string>);
var
  LValue:      TTomlValue;
...
function TMyrConfig.GetFileComment(): string;
begin
  if Assigned(FToml) then
...
procedure TMyrConfig.SetFileComment(const AComment: string);
begin
  if not Assigned(FToml) then
    FToml := TToml.Create();
...
function TMyrConfig.GetTableComment(const AKeyPath: string;
  const AIndex: Integer): string;
var
  LValue: TTomlValue;
  LArray: TTomlArray;
...
procedure TMyrConfig.SetTableComment(const AKeyPath: string;
  const AIndex: Integer; const AComment: string);
var
  LValue: TTomlValue;
  LArray: TTomlArray;
