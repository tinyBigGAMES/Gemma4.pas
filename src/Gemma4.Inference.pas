...
begin
  ...
  try
    ...
    // The prompt is the FULL re-rendered history: clear the KV cache and
    // position so prefill starts at 0 (each Generate call is stateless)
    FModel.Reset();
    ...
    FModel.Generate(
      ...
      begin
        ...
        // literal text by ID
        if ATokenId = FTokChannelStart then
